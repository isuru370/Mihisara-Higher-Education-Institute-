        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input
                    type="text"
                    name="card_qr_code"
                    class="form-control custom-input @error('card_qr_code') is-invalid @enderror"
                    value="{{ old('card_qr_code') }}"
                    placeholder="Scan Student Card QR Code"
                    autofocus
                    required>

                <small class="text-muted">
                    Scan the QR code printed on the physical student card.
                </small>
