...
@section('title', 'Student Card Registration')
@section('page-title', 'Student Card Registration')
...
@section('content')
    <div class="student-page">
            ...
            <div class="hero-content">
                ...
                <div>
                    ...
                    <p class="mb-0 text-muted">
                        Register a student using a physical student card.
                    </p>
        ...
        <div class="main-card">
            ...
            <form method="POST" action="{{ route('admin.student-card-registration.store') }}"
                enctype="multipart/form-data">
                @csrf

                @include('admin.student-card-registration.partials.form', [
                    'student' => null,
                    'grades' => $grades,
